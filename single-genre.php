...
$sql = "SELECT * FROM `categories` WHERE `id` = '$id_genre'";
            ...
            <div class="wrapper single">
                <div class="container">
                    <div class="content">
                        <div class="sidebar">
                            <?php 
                                single_cat($mysqli, $id_genre);
                            ?>
                        </div>
                        <div class="main">
                            <h1>Известные треки жанра <?= $resCat['name'] ?></h1>
                            <div class="loop__music--card">
                                <?php 
                                    post_loop($mysqli, $id_genre, 6, 'cat_id');
                                ?>
                            </div>
                        </div>
                    </div>
